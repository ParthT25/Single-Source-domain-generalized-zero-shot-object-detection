...
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/gen_loss.pkl', 'rb') as file:
    gen_loss = pickle.load(file)
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/class_loss.pkl', 'rb') as file:
    class_loss = pickle.load(file)    
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/disc_loss.pkl', 'rb') as file:
    disc_loss = pickle.load(file)   
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/bus_loss.pkl', 'rb') as file:
    bus_loss = pickle.load(file) 
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/mode_loss.pkl', 'rb') as file:
    mode_loss = pickle.load(file) 
with open('/u/student/2022/cs22mtech14005/Single-Source-domain-generalized-zero-shot-object-detection/WC-DCGAN/loss_files/retrain_loss.pkl', 'rb') as file:
...
plt.legend()
plt.show()
plt.savefig('plots/overall WC-DCGAN Loss')
plt.close()
